...
def exact_method_of_equal_shares_with_completion_approval(pabulib_file: str, budget=0):
    """
    ...
    return df
    # return most_efficient_project_set, efficiency_tracker, prev_project_set, final_efficiency, budget_increase_count, len(budget_increase_list), max(budget_increase_list), min(budget_increase_list), sum(budget_increase_list)/len(budget_increase_list)
...
def exact_method_of_equal_shares_with_completion_approval_exhasutive(pabulib_file: str, budget=0):
    """
    Run the Exact Equal Shares method with efficient budget completion.
...
if __name__ == "__main__":
    ...
    results_dir = base_dir / "results/exact_equal_shares/approval/exact_method_of_equal_shares_with_completion_approval_exhasutive_results"
    ...
    try:
        ...
        output_df = exact_method_of_equal_shares_with_completion_approval_exhasutive(str(input_path))
