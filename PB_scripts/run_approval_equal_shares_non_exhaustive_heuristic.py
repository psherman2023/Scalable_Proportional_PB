...
def exact_method_of_equal_shares_with_completion_approval_heuristic(pabulib_file: str, budget=0):
    """
...
if __name__ == "__main__":
    ...
    results_dir = base_dir / "results/exact_equal_shares/approval/exact_method_of_equal_shares_with_completion_approval_heuristic_results"
