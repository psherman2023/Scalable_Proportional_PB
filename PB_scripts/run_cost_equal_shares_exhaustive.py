...
def exact_method_of_equal_shares_with_completion_cost_exhaustive(pabulib_file: str, budget=0):
    """
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python run_exact_method_of_equal_shares_cost.py <file_path>")
        sys.exit(1)
    ...
    results_dir = base_dir / "results/exact_equal_shares/cost/exact_method_of_equal_shares_with_completion_cost_exhaustive"
    ...
    try:
        ...
        output_df = exact_method_of_equal_shares_with_completion_cost_exhaustive(str(input_path))
