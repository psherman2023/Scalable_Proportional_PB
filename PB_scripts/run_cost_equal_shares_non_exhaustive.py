...
def exact_method_of_equal_shares_with_completion_cost(pabulib_file: str, budget=0):
    """
    ...
    while True:
        ...
        min_budget_increase = add_opt_cost(
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python exact_method_of_equal_shares_with_completion_cost.py <file_path>")
        sys.exit(1)
    ...
    results_dir = base_dir / "results/exact_equal_shares/cost/exact_method_of_equal_shares_with_completion_cost"
