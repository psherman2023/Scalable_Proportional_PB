...
# sorted_selected_with_bpb is a dict with project:bpb
...
def exact_method_of_equal_shares_with_completion_cost_heuristic(pabulib_file: str, budget=0):
    """
...
if __name__ == "__main__":
    ...
    results_dir = base_dir / "results/exact_equal_shares/cost/exact_method_of_equal_shares_with_completion_cost_heuristic"
    ...
    try:
        ...
        output_df = exact_method_of_equal_shares_with_completion_cost_heuristic(str(input_path))
