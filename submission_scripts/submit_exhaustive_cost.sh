...
CUSTOM_FUNCTION_PATH="/data/coml-humanchess/univ5678/PB_scripts/run_cost_equal_shares_exhaustive.py"
...
do
   ...
   sbatch --time=47:59:00 --partition=medium --ntasks=1 --cpus-per-task=1 --job-name="$filename" --output="result_logs/results_exhaustive_cost/${filename}.out" --wrap="python3 $CUSTOM_FUNCTION_PATH $file"
