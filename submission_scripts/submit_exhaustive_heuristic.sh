...
FILES_DIR="/data/coml-humanchess/univ5678/PB_Data/PB/2024-09-26_20-45-53_pabulib_approval_exhaustive_heuristic_2"
...
#SBATCH --job-name=equal_shares
#SBATCH --output=equal_shares_%j.out
#SBATCH --error=equal_shares_%j.err
...
CUSTOM_FUNCTION_PATH="/data/coml-humanchess/univ5678/PB_scripts/run_approval_equal_shares_exhaustive_heuristic.py"
...
do
   ...
   sbatch --partition=long --ntasks=2 --cpus-per-task=1 --job-name="$filename" --output="result_logs/results_exhaustive_heuristic/${filename}.out" --wrap="python3 $CUSTOM_FUNCTION_PATH $file"
