...
FILES_DIR="/data/coml-humanchess/univ5678/PB_Data/PB/2024-09-26_20-45-53_pabulib_approval_non_exhaustive_2"
...
CUSTOM_FUNCTION_PATH="/data/coml-humanchess/univ5678/PB_scripts/run_approval_equal_shares_non_exhaustive.py"
...
do
   ...
   sbatch --partition=long --ntasks=1 --cpus-per-task=1 --job-name="$filename" --output="result_logs/results_non_exhaustive/${filename}.out" --wrap="python3 $CUSTOM_FUNCTION_PATH $file"
