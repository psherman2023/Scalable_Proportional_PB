...
CUSTOM_FUNCTION_PATH="/data/coml-humanchess/univ5678/PB_scripts/run_cost_waterflow_non_exhaustive.py"
...
do
   ...
   sbatch --partition=long --ntasks=1 --cpus-per-task=1 --job-name="$filename" --output="result_logs/results_cost_waterflow_non_exhaustive/${filename}.out" --wrap="python3 $CUSTOM_FUNCTION_PATH $file"
